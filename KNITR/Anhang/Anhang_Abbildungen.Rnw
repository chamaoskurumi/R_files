...
\afterpage{
\begin{landscape}
<<ViolinFortZuzuegeI, fig.width=9.8, fig.height=5.6, fig.scap='Verteilungen der wohnräumlichen Mobilität für die innere Stadt', fig.cap='Verteilungen der wohnräumlichen Mobilität (\\textit{Fortzüge, Zuzüge, FortzügeA, ZuzügeA}) für die innere Stadt', fig.lp='fig:',fig.pos='H'>>=
...
<<FortzuegeRMAP,fig.height=5, fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{Fortzüge}}", fig.lp='fig:',fig.pos='H'>>=
...
<<ZuzuegeRMAP,fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{Zuzüge}}", fig.height=5, fig.lp='fig:', fig.pos='H'>>=
...
<<IntraLOR,fig.height=3.8,fig.scap="Anteil der Umzüge innerhalb der LOR an allen Fortzügen in \\%", fig.cap="Zeitverlauf des Anteils der Umzüge innerhalb der LOR an allen Fortzügen in \\% nach \\textit{Kategorie}. Aufgrund einer fehlerhaften Lieferung durch das Amt für Statistik Berlin Brandenburg stehen keine Daten für Intra-LOR Umzüge für das Jahr 2007 zur Verfügung.", fig.lp='fig:',fig.pos='H', cache=FALSE>>=
load(file = "/home/dao/Desktop/MasterArbeit/R_files/INTRAdflong.Rdata")

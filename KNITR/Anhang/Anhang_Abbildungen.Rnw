...
\newpage
<<OekoVerdraengungAMAP, fig.scap="Karte der ökonomischen Verdrängungsraten (Version A)", fig.cap="\\href{http://www.gmx.de}{Karte der geschätzten ökonomischen Verdrängungsraten nach Version A: Anteil der zwischen 2007 und 2012 ökonomisch Verdrängten an der Gesamtbevölkerung in \\%.}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
...
<<OekoVerdraengungBMAP, fig.scap="Karte der ökonomischen Verdrängungsraten (Version B)", fig.cap="\\href{http://www.gmx.de}{Karte der geschätzten ökonomischen Verdrängungsraten nach Version B: Anteil der auf immobilienwirtschaftliche Aufwertung zurückzuführende jährliche Binnenfortzugsrate in \\%.}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=

...
<<Assoc, fig.cap='Assozationsplot von $\\Delta_{r}Miete$ und $\\Delta Armut$ nach gewichteten Quartilen. Für die \\textit{Kategorie} Gentri besteht ein hoch signifikanter Zusammenhang zwischen Mietpreissteigerung und  Armutssenkung.', fig.scap='Assozationsplot von $\\Delta_{r}Miete$ und $\\Delta Armut$', fig.lp='fig:',fig.pos='H', fig.height=3, fig.width=4, crop=TRUE, fig.align='center'>>=
assoc(mosaicDF,shade=TRUE) 
@

\newpage
<<Miete.2007MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Miete_{2007}$}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
...
<<Miete.2012MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Miete_{2012}$}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
...
<<Armut.2007MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Armut_{2007}$}", fig.height=5, fig.lp='fig:',fig.pos='H'>>=
...
<<Armut.2012MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Armut_{2012}$}", fig.height=5, fig.lp='fig:',fig.pos='H'>>=
...
<<FortzuegeRMAP,fig.height=5, fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{FortzügeB}}", fig.lp='fig:',fig.pos='H'>>=
...
<<ZuzuegeRMAP,fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{ZuzügeB}}", fig.height=5, fig.lp='fig:', fig.pos='H'>>=
...
<<FortzuegeUDARMAP,fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{FortzügeA}}", fig.height=5, fig.lp='fig:', fig.pos='H'>>=
...
<<ZuzuegeUDARMAP,fig.height=5, fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{ZuzügeA}}", fig.lp='fig:',fig.pos='H'>>=
...
grid.arrange(pIntraG, pIntraI, ncol=2, nrow=1, widths=c(1,1))
@

\newpage
<<ResiduenEpsilonMAP, fig.scap="Karte der Residuen $\\hat{\\varepsilon}$ des SAR Modells \\textit{FortzügeB}", fig.cap="\\href{http://www.gmx.de}{Karte der Residuen $\\hat{\\varepsilon}$ des gewichteten SAR Modells auf \\textit{FortzügeB} (Modell 1)}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
ResiduenEpsilonMAP
@

<<ResiduenEMAP, fig.scap="Karte der räumlichen Komponente des SAR Modells \\textit{FortzügeB}", fig.cap="\\href{http://www.gmx.de}{Karte der räumlichen Komponente $\\hat{Y}-X^{T}\\hat{\\beta}$ des gewichteten SAR Modells auf \\textit{FortzügeB} (Modell 1)}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
ResiduenEMAP
@

\newpage
<<OekoVerdraengungAMAP, fig.scap="Karte der geschätzten ökonomischen Verdrängungsraten (Version A)", fig.cap="\\href{http://www.gmx.de}{Karte der geschätzten ökonomischen Verdrängungsraten nach Version A, also als Anteil der zwischen 2007 und 2012 ökonomisch Verdrängten an der Gesamtbevölkerung in \\%.}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=
...
<<OekoVerdraengungBMAP, fig.scap="Karte der geschätzten ökonomischen Verdrängungsraten (Version B)", fig.cap="\\href{http://www.gmx.de}{Karte der geschätzten ökonomischen Verdrängungsraten nach Version B, also als auf immobilienwirtschaftliche Aufwertung zurückzuführenden Anteil der jährlichen Binnenfortzüge in \\%.}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=

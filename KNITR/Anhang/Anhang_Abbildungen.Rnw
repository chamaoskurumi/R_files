...
<<OekoVerdraengungBMAP, fig.scap="Karte der ökonomischen Verdrängungsraten (Version B)", fig.cap="\\href{http://www.gmx.de}{Karte der geschätzten ökonomischen Verdrängungsraten nach Version B: Anteil der Binnenfortzüge, der auf immobilienwirtschaftliche Aufwertung zurückzuführenden ist in \\%.}", fig.height=4.8, fig.lp='fig:',fig.pos='H'>>=

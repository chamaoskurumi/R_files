...
<<MosaicAssoc, fig.cap='Visualisierung des Zusammenhangs von $\\Delta_{r}Miete$ und $\\Delta Armut$ nach gewichteten Quartilen. Die Zelle Q4($\\Delta_{r}Miete$) / Q1($\\Delta Armut$) entspricht der \\textit{Kategorie} Gentri. Nach (b) besteht ein hoch signifikanter Zusammenhang zwischen starker Mietpreissteigerung und starker Armutssenkung.', fig.scap='Visualisierung des Zusammenhangs von $\\Delta_{r}Miete$ und $\\Delta Armut$', fig.subcap=c('Mosaikplot', 'Assoziationsplot'), out.width='0.48\\linewidth',fig.lp='fig:'>>=
...
\newpage
<<Miete.2007MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Miete_{2007}$}", fig.height=4.8, fig.lp='fig:'>>=
...
<<Miete.2012MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Miete_{2012}$}", fig.height=4.8, fig.lp='fig:'>>=
...
<<Armut.2007MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Armut_{2007}$}", fig.height=5, fig.lp='fig:'>>=
...
<<Armut.2012MAP, fig.cap="\\href{http://www.gmx.de}{Karte von $Armut_{2012}$}", fig.height=5, fig.lp='fig:'>>=
...
\afterpage{
\begin{landscape}
<<ViolinFortZuzuegeI, fig.width=9.8, fig.height=5.6, fig.scap='Verteilungen der wohnräumlichen Mobilität in der inneren Stadt', fig.cap='Verteilungen der wohnräumlichen Mobilität (\\textit{Fortzüge, Zuzüge, FortzügeA, ZuzügeA}) in der inneren Stadt', fig.lp='fig:'>>=
...
<<FortzuegeUDARMAP,fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{FortzügeA}}", fig.height=5, fig.lp='fig:', cache=FALSE>>=
...
<<ZuzuegeRMAP,fig.cap="\\href{http://www.gmx.de}{Karte von \\textit{Zuzüge}}", fig.height=5, fig.lp='fig:', cache=FALSE>>=

...
\usepackage[backend=bibtex, style=authoryear-comp, language=ngerman, isbn=false, url=false, doi=false, eprint=false, natbib=true, citestyle=authoryear-comp]{biblatex}
...
@
%\input{ForschungsdesignUNDmethoden/ForschungsdesignUNDmethoden}
